...
define("com.muxistudio.lib.main", function(e) {
  !(function(e) {
    ...
    function(e, t, n) {
      ...
      (t.default = {
        ...
        mount: function(e, t, n) {
          ...
          var v = (0, u.createElement)(h.default, null, e),
            y = (0, s.default)(v),
            m = r || {},
    ...
    function(e, t, n) {
      ...
      function l(e, t, n) {
        ...
        if (e && e.defaultProps) {
          ...
          for (a in v) void 0 === r[a] && (r[a] = v[a]);
        }
        return (
          r.style &&
            (Array.isArray(r.style) || "object" === d(r.style)) &&
            (r.style = u(r.style)),
          new i(e, l, f, r, h.default.component)
        );
      }
      function f(e) {
        var t = l.bind(null, e);
      ...
      function s(e, t) {
        ...
        var n = Object.assign({}, e.props),
          ...
          a = e._owner;
        if (t) {
          void 0 !== t.ref && ((u = t.ref), (a = h.default.component)),
                  ...
                  if (null != e || null != r) {
                    ...
                    if (null != e) {
                      ...
                      for (var u = 0, l = e.length; u < l; u++) {
                        ...
                        if (null != d && (0, p.default)(h, f))
                          d.updateComponent(h, f, t, t), (o[s] = d);
                        else {
                          if (d) {
                            ...
                            if (d === c) {
                              ...
                              if (
                                ...
                                for (var h = p.length - 1; h >= 0; h--)
                                  a.default.driver.insertAfter(p[h], l);
                              }
                              (f = f.concat(p)),
                              ...
                              Array.isArray(v) && (v = n._parent),
                                c.mountComponent(v, n._instance, t, function(
                                  e,
                                  t
                                ) {
                                  var n = i[s];
                                  if ((Array.isArray(e) || (e = [e]), n)) {
                                    ...
                                    for (var p = e.length - 1; p >= 0; p--) {
                                      var h = e[p];
                                      l
                                        ? a.default.driver.insertAfter(h, l)
                                        : d
                                          ? a.default.driver.insertBefore(h, d)
                                          : a.default.driver.appendChild(h, t);
                                    }
                                  }
                                  f = f.concat(e);
                                }),
    ...
    function(e, t, n) {
      ...
      function a(e, t) {
        return (0, v.createElement)(y, { element: e, container: t });
      }
      Object.defineProperty(t, "__esModule", { value: !0 });
      var l = (function() {
        function e(e, t) {
    ...
    function(e, t, n) {
      ...
      function o(e) {
        ...
        if (
          ...
          (a.default.CompositeComponent = v.default),
                ...
                value: function(e, t, n, r) {
                  ...
                  return (
                    ...
                    null == b &&
                      ...
                      (y.state = this._processPendingState(a, h)),
                      i(
                        function() {
                          b = y.render();
                        },
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  if (
                    ...
                    n && v.default.detach(this._currentElement._owner, n, this),
                    ...
                    (this._pendingForceUpdate ||
                      (o.shouldComponentUpdate
                        ...
                        : o.isPureComponentClass &&
                          (s = !(0, x.default)(d, l) || !(0, x.default)(h, y))),
                    s)
                  ) {
                    this._pendingForceUpdate = !1;
                    var m = o.context;
    ...
    function(e, t, n) {
      ...
      var a = (function() {
        ...
        _ = r(g),
        x = n(23),
        w = { position: "absolute", top: 0, left: 0, width: 750 },
        C = (function(e) {
          function t(e) {
            o(this, t);
            var n = i(
                ...
                value: function() {
                  ...
                  return (0, l.createElement)(
                    ...
                    (0, l.createElement)(_.default, {
                      pageId: "com.muxistudio.lib",
                      style: w
                    }),
                    (0, l.createElement)(d.default, {
                      style: O.searchCenterPicture,
                      source: h.default,
                      resizeMode: "contain"
                    }),
                    ...
                    (0, l.createElement)(y.default, {
                      onPress: this.nav,
                      style: O.searchButtonContainner,
                      textStyle: O.searchButtonText,
                      text: "搜索"
                    })
                  );
                }
        ...
        x = (function(e) {
          function t() {
            ...
            return (
              ...
              (r.onBtnPressed = function() {
                "alert" === r.state.type
                  ? r.setState({ show: !1 })
                  : "link" === r.state.type && _.push(r.state.link);
              }),
              (u = n),
              i(r, u)
            );
              ...
              },
              {
                ...
                value: function() {
                  return "" !== this.state.text && this.state.show
                    ? (0, g.createElement)(
                        f.default,
                        { style: [y.default.container, this.props.style] },
                        (0, g.createElement)(
                          c.default,
                          { style: [y.default.text, y.default.main_text] },
                          this.state.text
                        ),
                        (0, g.createElement)(
                          h.default,
            ...
            l(t, [
              {
                ...
                value: function() {
                  ...
                  e.color && n.push({ color: e.color }),
                    e.disabled &&
                      (t.push(v.buttonDisabled), n.push(v.textDisabled));
                ...
                value: function() {
                  var e = this.props,
                    ...
                    C = l({}, this.props, {
                      "aria-label": t,
                      autoComplete: n && "on",
                      onChange: (v || y) && this.handleChange,
                  ...
                  var O = d[o];
                  if (((b || g) && (O = "password"), c.isWeex)) {
                    var A = Boolean(C.readOnly);
                    return u
                      ? (0, s.createElement)(
                          "textarea",
                          l({}, C, { rows: 20, disabled: A })
                        )
                      : (0, s.createElement)(
                          "input",
                          l({}, C, { type: O, disabled: A })
                        );
                  }
                  var P = void 0;
                  if (u) {
                    var E = { maxRows: i || a, minRows: a };
                    P = (0, s.createElement)("textarea", l({}, C, E), C.value);
                  } else
                    P = (0, s.createElement)("input", l({}, C, { type: O }));
                  return P;
                }
              }
            ]),
